...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):  # type: ignore[override]
        ...
        # Google Pay) and opens payment providers in new tabs, so those origins
        # are allowed for scripts/frames/connections.
        headers.setdefault(
            "Content-Security-Policy",
            "default-src 'self'; "
            "img-src 'self' data: blob: https:; "
            "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com "
            "https://applepay.cdn-apple.com https://cdn.jsdelivr.net; "
            ...
            "https://pay.google.com https://api.stripe.com https://r.stripe.com "
            "https://www.google-analytics.com https://region1.google-analytics.com "
            "https://www.googletagmanager.com "
            "https://geocoding-api.open-meteo.com "
            "https://adelinetarot2.onrender.com; "
            "frame-src https://www.paypal.com https://www.sandbox.paypal.com "
            "https://pay.google.com https://js.stripe.com https://checkout.stripe.com; "
            "base-uri 'self'; "
            "form-action 'self'; "
